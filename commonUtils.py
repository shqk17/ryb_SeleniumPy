...
def create_phone():
    # 第二位数字
    second = [3, 4, 5 , 8][random.randint(0, 3)]
...
def checkClassNameIsExist(driver, name):
    try:
        ele = driver.find_element_by_class_name('name')
        print(name + "_is_Exist")
        return True
    except:
        print(name + "_is_not_Exist")
        return False
